function getLocation() {
  ...
  function showPosition(position) {
    ...
    console.log(long);
              ...
              //**********************************************
          var map = L.map('mapContainer').setView([lat,long ], 8);
...
var date = new Date(horadecalculodedatos*1000);
// Hours part from the timestamp
var hours = date.getHours();
// Minutes part from the timestamp
var minutes = "0" + date.getMinutes();
...
// Will display time in 10:30:23 format
var formattedTime3 = hours + ':' + minutes.substr(-2) + ':' + seconds.substr(-2);
...
console.log(descripcionclima);
       ...
       /*document.getElementById("demo2").innerHTML = y;*/
              ...
              L.marker([lat,long ]).addTo(map).bindPopup('Aca estoy');
      //.openPopup();
